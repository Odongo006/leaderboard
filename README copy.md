...
> "Leadersboard" is a tool that helps to organize Scores. It simply lists the scores that students has score in a test. In this particular repo, We are building this Leaderboard with using HTML, CSS, JavaScript (ES6), and Webpack.
...
```
$ git clone https://github.com/Odongo006/Leadersboard.git
```
### Usage

To run the project, execute the following command: 
- Repository[@repo](https://github.com/Odongo006/Leadersboard.git)
